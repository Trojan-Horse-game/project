...
export class GameScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    let dealCards = () => {
      for (let i = 0; i < 3; i++) {
        ...
        playerCard.displayCard(
          this.playerPosition[0][0] + 160 + i * 170,
          this.playerPosition[0][1] - 5,
          "carte_verso"
        );
      }
    };
    ...
    let renderZone = tas_zone.renderZone(
      width / 2,
      height / 2,
      150,
      150,
...
*/
    ...
    graphicsGen[0] = this.generators[0][0].displayGenerator(
      x + 170,
      y - 155,
      "foudre",
      "foudre_0"
    );
    graphicsGen[1] = this.generators[0][1].displayGenerator(
      x + 250,
      y - 155,
      "air",
      "air_0"
    );
    graphicsGen[2] = this.generators[0][2].displayGenerator(
      x + 330,
      y - 155,
      "eau",
      "eau_0"
    );
    graphicsGen[3] = this.generators[0][3].displayGenerator(
      x + 410,
      y - 155,
      "radiation",
      "radiation_0"
    );
    graphicsGen[4] = this.generators[0][4].displayGenerator(
      x + 490,
      y - 155,
      "super",
      "super_0"
    ...
    graphicsGen[5] = this.generators[1][0].displayGenerator(
      x + 95,
      y - 80,
      "foudre",
      "foudre_1"
    );
    graphicsGen[6] = this.generators[1][1].displayGenerator(
      x + 110,
      y,
      "air",
      "air_1"
    );
    graphicsGen[7] = this.generators[1][2].displayGenerator(
      x + 95,
      y + 75,
      "eau",
      "eau_1"
    );
    graphicsGen[8] = this.generators[1][3].displayGenerator(
      x + 25,
      y + 110,
      "radiation",
      "radiation_1"
    );
    graphicsGen[9] = this.generators[1][4].displayGenerator(
      x - 50,
      y + 110,
      "super",
      "super_1"
    ...
    graphicsGen[10] = this.generators[2][0].displayGenerator(
      x + 95,
      y - 80,
      "foudre",
      "foudre_2"
    );
    graphicsGen[11] = this.generators[2][1].displayGenerator(
      x + 110,
      y,
      "air",
      "air_2"
    );
    graphicsGen[12] = this.generators[2][2].displayGenerator(
      x + 95,
      y + 75,
      "eau",
      "eau_2"
    );
    graphicsGen[13] = this.generators[2][3].displayGenerator(
      x + 25,
      y + 110,
      "radiation",
      "radiation_2"
    );
    graphicsGen[14] = this.generators[2][4].displayGenerator(
      x - 50,
      y + 110,
      "super",
      "super_2"
    ...
    graphicsGen[15] = this.generators[3][0].displayGenerator(
      x - 110,
      y - 30,
      "foudre",
      "foudre_3"
    );
    graphicsGen[16] = this.generators[3][1].displayGenerator(
      x - 100,
      y + 65,
      "air",
      "air_3"
    );
    graphicsGen[17] = this.generators[3][2].displayGenerator(
      x,
      y + 110,
      "eau",
      "eau_3"
    );
    graphicsGen[18] = this.generators[3][3].displayGenerator(
      x + 100,
      y + 65,
      "radiation",
      "radiation_3"
    );
    graphicsGen[19] = this.generators[3][4].displayGenerator(
      x + 110,
      y - 30,
      "super",
      "super_3"
    ...
    graphicsGen[20] = this.generators[4][0].displayGenerator(
      x - 105,
      y - 60,
      "foudre",
      "foudre_4"
    );
    graphicsGen[21] = this.generators[4][1].displayGenerator(
      x - 120,
      y + 15,
      "air",
      "air_4"
    );
    graphicsGen[22] = this.generators[4][2].displayGenerator(
      x - 110,
      y + 90,
      "eau",
      "eau_4"
    );
    graphicsGen[23] = this.generators[4][3].displayGenerator(
      x - 30,
      y + 110,
      "radiation",
      "radiation_4"
    );
    graphicsGen[24] = this.generators[4][4].displayGenerator(
      x + 50,
      y + 110,
      "super",
      "super_4"
    ...
    graphicsGen[25] = this.generators[5][0].displayGenerator(
      x - 95,
      y - 80,
      "foudre",
      "foudre_5"
    );
    graphicsGen[26] = this.generators[5][1].displayGenerator(
      x - 110,
      y,
      "air",
      "air_5"
    );
    graphicsGen[27] = this.generators[5][2].displayGenerator(
      x - 100,
      y + 75,
      "eau",
      "eau_5"
    );
    graphicsGen[28] = this.generators[5][3].displayGenerator(
      x - 30,
      y + 115,
      "radiation",
      "radiation_5"
    );
    graphicsGen[29] = this.generators[5][4].displayGenerator(
      x + 50,
      y + 110,
      "super",
      "super_5"
